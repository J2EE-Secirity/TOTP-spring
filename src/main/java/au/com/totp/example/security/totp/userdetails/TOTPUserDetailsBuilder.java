...
public class TOTPUserDetailsBuilder {
    ...
    public static final String DEFAULT_SECRET = "xxxxxx";
    @SuppressWarnings("unchecked") public static final Collection<GrantedAuthority> DEFAULT_AUTHORITIES = (Collection) Arrays.asList(new SimpleGrantedAuthority("ROLE"));
